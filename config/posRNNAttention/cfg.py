...
class Config():
    def __init__(self):
        ...
        # Environment & Path
        self.train_data_file = os.path.join(root_path, 'Data/nlp/pos/pos_train.json')
        self.valid_data_file = os.path.join(root_path, 'Data/nlp/pos/pos_valid.json')
        self.test_data_file = os.path.join(root_path, 'Data/nlp/pos/pos_test.json')
