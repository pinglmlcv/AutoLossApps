...
def generateMTData():
    data_dir = os.path.join(root_dir, 'Data/nlp/mt')
...
def generatePOSData():
    data_dir = os.path.join(root_dir, 'Data/nlp/pos')
    ...
    subword_de_dict_name = os.path.join(root_dir, 'Data/nlp/mt/subword.de.dict')
    ...
    subword_de_stream = open(subword_de_name, 'r')
    subword_pos_stream = open(subword_pos_name, 'r')
    de_token_id = get_token_id(os.path.join(root_dir, 'Data/nlp/mt/de_token_id.json'))
    postag_id = postag_id
...
def generateNERData():
    data_dir = os.path.join(root_dir, 'Data/nlp/ner')
